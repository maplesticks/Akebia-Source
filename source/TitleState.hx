...
class TitleState extends MusicBeatState
{
	...
	var gradientBar:FlxSprite = new FlxSprite(0, 0).makeGraphic(FlxG.width, 1, 0xFF7A7F83);
	...
	//	add(gfDance);
		...
		gradientBar = FlxGradient.createGradientFlxSprite(FlxG.width, 820, [0x00ffffff, 0x55939393, 0xAA000000], 1, 90, true);
